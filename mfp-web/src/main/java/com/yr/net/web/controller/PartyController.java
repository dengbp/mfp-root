...
public class PartyController {
    ...
    @Resource
    PartyItemService partyItemService;
    @Resource
    ...
    /**
     * 约会项目接口
     * @param ThemeId 约会主题id
     * @return
     */
    @GetMapping("/item/query")
    public AjaxResponse queryPartItem(@RequestParam("ThemeId") Long ThemeId){
        List<PartyItem> list = partyItemService.findByThemeId(ThemeId);
        return AjaxResponse.success().setResult(list).setMsg("查询成功");
    }
